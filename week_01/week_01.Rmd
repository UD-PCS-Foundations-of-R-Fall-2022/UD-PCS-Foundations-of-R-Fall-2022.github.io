...
pacman::p_install_gh("hadley/emo")

pacman::p_install_gh("gadenbuie/xaringanExtra")
...
```{r format, echo=FALSE}
source(here::here("scripts", "markdown_format.R"))
```
...
.pull-right[
### Tech Impact
Data Innovation Lab, Director, Strategy & Operations
...
--
### Focus on identifying projects that you care about
...
6.    Manipulation of Strings, Factors, and Datetimes
...
You can read the full course syllabus [here](https://udel.instructure.com/courses/1626501/assignments/syllabus).
...
-   Due one week after your last class, May 9, 2022
...
#### Skill Level of Foundations of R Course Participants
As of *`r format(Sys.Date(), format = '%B %e, %Y')`* at *`r format(Sys.time(), format = '%I:%M %p')`*

```{r, echo=FALSE, fig.alt="Bubble chart demonstrating skill level of participants in the Foundations of R course", out.width="100%", out.height="350px"}
# Note: you will not be able to replicate this code without access to this file.
intro <- read_sheet("https://docs.google.com/spreadsheets/d/1121-5MwLvXQfAJcr8cBmAf_BA81Kjv95XiImFm0mrCc/edit?resourcekey#gid=1973707909")
...

{
  ...
  ggplot(aes(x = Level,
             y = Tool,
             size = n,
             text = glue::glue("{n} student{ifelse(n == 1, '', 's')}"))) +
...
Let's explore the `sample` function. Take a look at the vignette for it. What does it do? What are its arguments?

Here's a simple example of how we might use the `sample` function:
...
2. **Create** your first homework assignment repository
...
-  Open the [assignment URL](https://classroom.github.com/a/8DoUa_KP)

```{r, eval=FALSE}
https://classroom.github.com/a/8DoUa_KP
```

-  Accept the assignment.

-  Open the newly created repository. It will be named `week-01-assignment-<YOUR GITHUB USERNAME>`.
...
In normal weeks, your homework will be due by 5:59 pm on the day of the next class (i.e., this would normally be due March 21, 2022 at 5:59 pm).
...
.pull-right[<img src="../assets/images/Slack.png" alt="Slack screenshot" style="width:600px" class="rounded-corners">]
...
<br>
<br>
# `r emo::ji("clipboard")` [Survey](https://docs.google.com/forms/d/e/1FAIpQLSfN3sOBG5PqiFdGUWO5IlUsNvcFYQQkPpBDfTATUhYkEzEWRQ/viewform)
<br>
<br>
<br>
*If the link above is not working, copy this into your browser.*
```{r, eval=FALSE}
https://docs.google.com/forms/d/e/1FAIpQLSfN3sOBG5PqiFdGUWO5IlUsNvcFYQQkPpBDfTATUhYkEzEWRQ/viewform
```
]
